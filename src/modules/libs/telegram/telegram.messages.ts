...
export const MESSAGES = {
	...
	// follows: (user: User) =>
	// `📺 <a href="https://miodly.ru/${user.username}">${user.username}</a>`,
	...
	// 	`Смотрите здесь: <a href="https://miodly.ru/${channel.username}">Перейти к трансляции</a>`,
	...
	// 		`Спасибо, что вы с нами и продолжаете развивать свой канал вместе с Miodly!`
}
